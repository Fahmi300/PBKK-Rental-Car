...
type UserService interface {
	RegisterUser(ctx context.Context, userDTO dto.UserCreateDto) (models.User, error)
	...
	MeUser(ctx context.Context, userID int) (models.User, error)
}
...
func (us *userService) RegisterUser(ctx context.Context, userDTO dto.UserCreateDto) (models.User, error) {
	user := models.User{}
...
func (us *userService) GetAllUser(ctx context.Context) ([]models.User, error) {
...
func (us *userService) MeUser(ctx context.Context, userID int) (models.User, error) {
